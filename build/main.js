...
exports.visit = exports.generateFile = exports.EnvOption = exports.LongOption = void 0;
...
function generateInterfaceDeclaration(typeMap, fullName, messageDesc, sourceInfo, options) {
    ...
    messageDesc.field.forEach((fieldDesc, index) => {
        ...
        let optional = options.useOptionals && types_1.isMessage(fieldDesc) && !types_1.isRepeated(fieldDesc);
        let prop = ts_poet_1.PropertySpec.create(maybeSnakeToCamel(fieldDesc.name, options), types_1.toTypeName(typeMap, messageDesc, fieldDesc, options), optional);
